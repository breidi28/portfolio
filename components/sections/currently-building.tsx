            ...
            <div className="grid gap-8 px-6 py-8 md:grid-cols-[1.2fr_0.8fr] md:px-8 md:py-10">
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  <h2 className="section-title md:text-[3.25rem]">
                    Music Share
                  </h2>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge variant="secondary" className="bg-background/70">Flask</Badge>
                  <Badge variant="secondary" className="bg-background/70">TypeScript</Badge>
                  <Badge variant="secondary" className="bg-background/70">OAuth</Badge>
                  <Badge variant="secondary" className="bg-background/70">JWT</Badge>
                  <Badge variant="secondary" className="bg-background/70">MusicBrainz API</Badge>
                </div>
